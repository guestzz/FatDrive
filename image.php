...
<body class="mdui-drawer-body-left mdui-appbar-with-toolbar  mdui-theme-primary-indigo mdui-theme-accent-pink mdui-theme-layout-auto">
    ...
    <div class="mdui-drawer" id="main-drawer">
        <div class="mdui-list" style="margin-bottom: 76px;">
            ...
            <a href="./image.php" class="mdui-list-item mdui-list-item-active mdui-ripple"><i class="mdui-list-item-icon mdui-icon material-icons mdui-text-color-pink">photo_library</i>
                <div class="mdui-list-item-content">
                    图片
                </div>
            </a>
...
<script type="text/javascript" src="./static/js/getimagelist.js"></script>
